...
public class DBController {
    ...
    public ResponseEntity<?> putStudy(
        ...
        //전체수정 {nickname: aaa, password: 1234} => {nickname: "", password: 1111} =>  {nickname: "", password: 1111}
    ...
    public ResponseEntity<?> patchStudy(
            @PathVariable int id,
            @RequestBody DBStudyReqDto dbStudyReqDto){
        //부분수정 {nickname: aaa, password: 1234} => {nickname: "", password: 1111} =>  {nickname: "aaa", password: 1111}
